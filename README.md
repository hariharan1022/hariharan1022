...
<a href="https://github.com/hariharan1022">
  <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=22&pause=1000&color=05D9E8&center=true&vCenter=true&width=600&lines=Founder%20%40%20Skyrovix%3BFull%20Stack%20Engineer%3BReact%20%26%20Node.js%20Developer%3BBuilding%20things%20that%20matter" alt="Typing SVG"/>
</a>

<br/><br/>

<a href="https://skyrovix.online"><img src="https://img.shields.io/badge/WEBSITE-skyrovix.online-BD00FF?style=for-the-badge&logo=vercel&logoColor=white&labelColor=0a0e27" alt="Website"/></a>
<a href="mailto:hariharanmahesh34@gmail.com"><img src="https://img.shields.io/badge/EMAIL-hariharanmahesh34%40gmail.com-FF2E97?style=for-the-badge&logo=gmail&logoColor=white&labelColor=0a0e27" alt="Email"/></a>
<a href="https://github.com/hariharan1022"><img src="https://img.shields.io/badge/GITHUB-hariharan1022-05D9E8?style=for-the-badge&logo=github&logoColor=white&labelColor=0a0e27" alt="GitHub"/></a>
...
<svg width="440" height="340" viewBox="0 0 440 340" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="term-accent" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="100%" stop-color="#05D9E8"><animate attributeName="stop-color" values="#05D9E8;#BD00FF;#FF2E97;#05D9E8" dur="6s" repeatCount="indefinite"/></stop>
    </linearGradient>
  </defs>
  ...
  <g font-family="'Fira Code','Consolas',monospace" font-size="13.5">
    ...
    <text x="20" y="118"><tspan fill="#05D9E8">$</tspan><tspan fill="#e4e4e7"> cat role.txt</tspan></text>
    <text x="20" y="140" fill="#FF2E97">&gt; Full Stack Engineer / React Developer</text>

    <text x="20" y="170"><tspan fill="#05D9E8">$</tspan><tspan fill="#e4e4e7"> cat education.txt</tspan></text>
    <text x="20" y="192" fill="#e4e4e7">&gt; B.Tech IT, Mount Zion (2022–26)</text>

    <text x="20" y="222"><tspan fill="#05D9E8">$</tspan><tspan fill="#e4e4e7"> echo $LOCATION</tspan></text>
    <text x="20" y="244" fill="#e4e4e7">&gt; India</text>

    <text x="20" y="274"><tspan fill="#05D9E8">$</tspan><tspan fill="#e4e4e7"> echo $GOAL</tspan></text>
    <text x="20" y="296" fill="#BD00FF" font-style="italic">&gt; "Build products that make a difference"</text>

    <text x="20" y="322"><tspan fill="#05D9E8">$</tspan><tspan fill="#e4e4e7"> _</tspan>
...
<svg width="390" height="340" viewBox="0 0 390 340" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="1" y="1" width="388" height="338" rx="14" fill="#0a0e27" stroke="#2a2f4c" stroke-width="1.5"/>
  <rect x="1" y="1" width="388" height="4" rx="2" fill="url(#ring-accent)"/>
  ...
  <g transform="translate(70,110)">
    ...
    <circle r="42" fill="none" stroke="#BD00FF" stroke-width="8" stroke-linecap="round" transform="rotate(-90)"
      ...
      <animate attributeName="stroke-dashoffset" from="264" to="13" dur="1.5s" fill="freeze"/>
    </circle>
    <text y="6" font-family="'Segoe UI',Arial,sans-serif" font-size="16" font-weight="700" fill="#f4f5f7" text-anchor="middle">95%</text>
  </g>
  ...
  <g transform="translate(195,110)">
    ...
    <circle r="42" fill="none" stroke="#FF2E97" stroke-width="8" stroke-linecap="round" transform="rotate(-90)"
      stroke-dasharray="264" stroke-dashoffset="264">
      <animate attributeName="stroke-dashoffset" from="264" to="40" dur="1.5s" begin="0.15s" fill="freeze"/>
    </circle>
    <text y="6" font-family="'Segoe UI',Arial,sans-serif" font-size="16" font-weight="700" fill="#f4f5f7" text-anchor="middle">85%</text>
  </g>
  ...
  <g transform="translate(320,110)">
    ...
    <circle r="42" fill="none" stroke="#05D9E8" stroke-width="8" stroke-linecap="round" transform="rotate(-90)"
      stroke-dasharray="264" stroke-dashoffset="264">
      <animate attributeName="stroke-dashoffset" from="264" to="79" dur="1.5s" begin="0.3s" fill="freeze"/>
    </circle>
    <text y="6" font-family="'Segoe UI',Arial,sans-serif" font-size="16" font-weight="700" fill="#f4f5f7" text-anchor="middle">70%</text>
  </g>
  <text x="320" y="172" font-family="'Segoe UI',Arial,sans-serif" font-size="11" fill="#a7a9be" text-anchor="middle">AI Apps</text>

  <line x1="24" y1="200" x2="366" y2="200" stroke="#1f2340" stroke-width="1"/>
